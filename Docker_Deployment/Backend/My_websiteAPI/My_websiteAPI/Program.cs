...
builder.Services.AddSingleton(new ElasticsearchClient(new ElasticsearchClientSettings(new Uri("http://host.docker.internal:9200"))));
...
}).AddJwtBearer(option =>
{
    ...
    option.RequireHttpsMetadata = false;// docker ưith false 
